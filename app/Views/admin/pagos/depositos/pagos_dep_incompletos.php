...
<?= $this->section('title') ?>
Pagos con depósitos incompletos
<?= $this->endSection() ?>
...
<div class="content-wrapper">
    ...
    <div class="content-header sty-one">
        <h1 class="text-black">Pagos con depósitos incompletos</h1>
        <ol class="breadcrumb">
            <li><a href="#">Inicio</a></li>
            <li><i class="fa fa-angle-right"></i>Pagos con depósitos incompletos</li>
        </ol>
    </div>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($depositos as $key => $deposito):
                            ...
                            <tr data-id-pago="<?= $deposito["id_pago"] ?>" data-ic="<?= $deposito["ic"] ?>"
                                ...
                                <td>
                                    <div class="d-flex">
                                    <?php if ($deposito['payment_status'] == '5'): ?>
