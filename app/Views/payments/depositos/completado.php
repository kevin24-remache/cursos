...
<div class="content-wrapper">
    <div class="content-header sty-one">
        <h1 class="text-black">Depósitos completados</h1>
        <ol class="breadcrumb">
            <li><a href="#">Inicio</a></li>
            <li class="sub-bread"><i class="fa fa-angle-right"></i> Depósitos completados</li>
        </ol>
    </div>
    <div class="content">
        <div class="info-box">
            <div class="table-responsive">
                <table id="depositos" class="table datatable table-bordered table-hover">
