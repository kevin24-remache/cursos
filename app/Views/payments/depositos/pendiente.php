...
<div class="content-wrapper">
    ...
    <div class="content-header sty-one">
        <h1 class="text-black">Depósitos Ingresados</h1>
        <ol class="breadcrumb">
            <li><a href="/punto/pago/">Inicio</a></li>
            <li><i class="fa fa-angle-right"></i>Depósitos Ingresados</li>
        </ol>
    </div>
                                ...
                                <td>
                                    <?php if ($deposito['payment_status'] == '4'): ?>
                                        <a href="<?= base_url('punto/pago/deposito/' . $deposito["id_pago"]) ?>"
                                            ...
                                            <i class="fa-lg fa fa-eye" aria-hidden="true"></i>
                                        </a>
                                    <?php endif; ?>
                                </td>
                            </tr>
